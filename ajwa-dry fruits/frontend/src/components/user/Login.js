        ...
        <Fragment>
            ...
            <div className="row wrapper justify-content-center my-5">
                <div className="col-10 col-lg-5">
                    <form onSubmit={submitHandler} className="shadow-lg p-4 rounded bg-dark text-white border border-warning">
                        <h2 className="mb-4 text-warning font-weight-bold text-center">User Login</h2>
                        ...
                        <button
                            id="login_button"
                            type="submit"
                            className="btn btn-warning btn-block py-3 font-weight-bold text-dark text-uppercase shadow w-100"
                            disabled={loading}
                        >
